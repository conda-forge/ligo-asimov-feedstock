About ligo-asimov-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ligo-asimov-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11302&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ligo-asimov-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ligo-asimov` can be installed with `conda`:
...
```
mamba install ligo-asimov
```

It is possible to list all of the versions of `ligo-asimov` available on your platform with `conda`:
...
```
mamba search ligo-asimov --channel conda-forge
```
...
mamba repoquery search ligo-asimov --channel conda-forge

# List packages depending on `ligo-asimov`:
mamba repoquery whoneeds ligo-asimov --channel conda-forge

# List dependencies of `ligo-asimov`:
mamba repoquery depends ligo-asimov --channel conda-forge
```
